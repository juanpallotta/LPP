...
class CMolecularData
{
	public:
		...
		void Get_Mol_Data_L2( strcGlobalParameters*, CNetCDF_Lidar*, int ) ;
	...
	private:
		...
		void Mol_Low_to_High_Res_Lin( ) ;

		void Tem_Pres_to_HR_Lin() 	;
		// void Tem_Pres_to_HR_Spl() 	;
		void Molecular_Profile_Resampled_Zenithal( strcGlobalParameters* ) ;
		void Molecular_Profile_Resampled_Zenithal_Lin( strcGlobalParameters* ) ;
		void Molecular_Profile_Resampled_Zenithal_v1( strcGlobalParameters* ) ;
};
